...
/**
 * Get optimized Cloudinary URL with compression and sizing
 * @param path The image path from the database or Cloudinary URL
 * @param options Optimization options
 * @returns The optimized complete URL to the image
 */
